package com.example.app_quote.data.local
...
import com.example.app_quote.data.local.daos.QuoteDao
import com.example.app_quote.data.local.entities.QuoteEntity
